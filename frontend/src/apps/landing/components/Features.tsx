...
export const Features: React.FC = () => {
  ...
  return (
        <section id="interns" className="py-20 bg-gradient-to-br from-[#B3EDEB]/20 to-white">
      <div className="container mx-auto px-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-[#1F7368] font-bold uppercase tracking-wide mb-4">Features</p>
          <h2 className="text-4xl lg:text-5xl font-bold text-[#004F4D] mb-6">
            Everything You Need to Succeed
          </h2>
          <p className="text-xl text-[#181C19]/70 max-w-3xl mx-auto">
            Powerful tools designed to connect interns with their dream internships and help companies find exceptional talent.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <div className="text-center lg:text-left mb-12">
              <h3 className="text-3xl font-bold text-[#1F7368] mb-4">For Interns</h3>
