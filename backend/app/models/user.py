"""
Optimized User Model - Authentication & Common Fields Only
No role-specific data, no duplication
"""
...
class User(Base):
    ...
    internship_history = relationship("InternshipHistory", back_populates="student", cascade="all, delete-orphan")
